        ...
        <div class="online_bar collapse" id="onlineSort1">
          ...
          <div class="online_content overz" id="onlineType1" style="display: block;">
            <ul class="overz">
	           ...
	           <li><a target="_blank" href="mqqwpa://im/chat?chat_type=wpa&uin=<s:property value="code"/>&version=1&src_type=web&web_src=oicqzone.com"><img border="0" src="http://wpa.qq.com/pa?p=2:<s:property value="code"/>:51" /></a></li>
	           </l:list>
	           <li>周一至周五</li>
	           <li>9:00-18:00</li>
	           <l:bean tab="Scontact" id="auto" var="contact"/>
              <li style="text-align:left;text-indent:10px;">电话：<s:property value="#contact.phone"/></li>
            </ul>
          </div>
          <!--online_content end-->
        </div>
