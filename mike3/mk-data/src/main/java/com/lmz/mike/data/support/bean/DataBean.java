...
import com.lmz.mike.data.util.BeanUtil;
...
public class  DataBean<T> extends LinkedHashMap implements Serializable,Cloneable{
	...
	public DataBean(){}
	public DataBean(Class<? extends T> c){
		this.clz = c;
	}
	public DataBean(Class<? extends T> c,Map params){
		this.clz = c;
		this.setMap(params);
	}
	public DataBean(Class<? extends T> c,Object...objects){
		this.clz = c;
