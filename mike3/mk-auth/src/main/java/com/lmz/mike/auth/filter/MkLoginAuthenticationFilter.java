package com.lmz.mike.auth.filter;

import com.lmz.mike.auth.pojo.MkAuthenticationToken;
 ...
 */
public class MkLoginAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public MkLoginAuthenticationFilter() {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException {
        ...
        MkAuthenticationToken authRequest;
        String principal;
        String credentials;
        ...
        authRequest = new MkAuthenticationToken(
