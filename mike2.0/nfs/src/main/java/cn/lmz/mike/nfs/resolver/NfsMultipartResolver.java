package cn.lmz.mike.nfs.resolver;

import cn.lmz.mike.nfs.listener.NfsProgressListener;
...
public class NfsMultipartResolver extends CommonsMultipartResolver
{
    // 注入第二步写的FileUploadProgressListener
    @Autowired
    private NfsProgressListener progressListener;

    public void setFileUploadProgressListener(NfsProgressListener progressListener)
    {
